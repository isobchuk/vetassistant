...
export RESULT_FOLDER_NAME CONFIGURATION BIN_FOLDER_NAME LIB_FOLDER_NAME OBJ_FOLDER_NAME WARNINGS WARNINGS_CPP FLAGS CFLAGS CXXFLAGS LDFLAGS LIBS INCLUDES QT_CFLAGS MOC
